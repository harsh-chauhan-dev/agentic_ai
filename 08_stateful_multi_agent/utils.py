...
async def update_interaction_history(
    ...
    """Add an entry to interaction_history using an ADK session event."""
    ...
    try:
        ...
        # Create an ADK event containing the state update
        event = Event(
            author="system",
        ...
        # Append event to existing session
...
async def add_user_query_to_history(
    ...
    """Add a user query to interaction history."""
...
async def add_agent_response_to_history(
    ...
    """Add an agent response to interaction history."""
...
async def call_agent_async(runner, user_id, session_id, query):
    ...
    try:
        ...
        print(
            f"{Colors.BG_RED}{Colors.WHITE}"
            f"ERROR during agent run: {e}"
            f"{Colors.RESET}"
        )
    ...
    print(
        f"{Colors.YELLOW}{'-' * 30}{Colors.RESET}"
    )
