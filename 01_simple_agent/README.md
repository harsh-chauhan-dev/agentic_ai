...
```
01_simple_agent/
    simple_agent/         # This is your agent's package directory
...
This example demonstrates a simple agent that responds to calculate and get_capital_city queries, showing the fundamentals of agent creation with ADK.